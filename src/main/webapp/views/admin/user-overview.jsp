  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<c:url value='/templates/admin/dist/img/ava1.png' />" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
           ...
           <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<c:url value='/admin/user?action=view'/>" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Overview</p>
                </a>
              </li>
                  ...
                  <tbody>
	                  <c:forEach items="${user}" var="item">
	                  		<tr>
	                  			...
	                  			<td>${item.email}</td>
	                  			<td>
	                  				<a href="<c:url value='/admin/user?action=edit&username=${item.username}'/>" type="button" class="btn btn-block btn-success btn-sm">Edit</a>
	                  				<button type="button" onclick="deleteUser('${item.username}')" class="btn btn-block btn-danger btn-sm">Delete</button>
	                  			</td>
	                  		</tr>
	                  </c:forEach>
                  </tbody>
