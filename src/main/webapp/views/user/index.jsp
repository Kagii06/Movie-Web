...
<title>ONLINE ENTERTAINNMENT</title>
...
<body>
	...
	<div class="container-fluid tm-container-content tm-mt-60">
		<div class="row mb-4">
			<h2 class="col-6 tm-text-primary">Popular on Netflix</h2>
		...
		<div class="row tm-mb-90">
			<div
				...
				<a href="javascript:void(0);"
					class="btn btn-danger tm-btn-prev mb-2 disabled">Previous</a>
				</c:if>
				<c:if test="${currentPage >1 }">
				<a href="index?page=${currentPage - 1}"
					class="btn btn-danger tm-btn-prev mb-2 ">Previous</a>
				</c:if>
				...
				<a href="javascript:void(0);" class="btn btn-danger tm-btn-next disabled">Next Page</a>
				</c:if>
				<c:if test="${currentPage < maxPage}">
				<a href="index?page=${currentPage + 1}" class="btn btn-danger tm-btn-next">Next Page</a>
				</c:if>
